    ...
    if is_amd():
        ...
        if not (any((a in arch) for a in AMD_RDNA2_AND_OLDER_ARCH)):
            ...
            if not torch.backends.cudnn.enabled:
                logging.info("ComfyUI has set torch.backends.cudnn.enabled to False for better AMD performance. Set environment var TORCH_BACKENDS_CUDDNN_ENABLED=1 to enable it again.")
